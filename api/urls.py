...
if PUBLISH_ONLY == "True":
    ...
    urlpatterns = [
        ...
        path("api/groups/modify/", ApiGroupsModify.as_view()),
        path("api/objects/drafts/create/", ApiObjectsDraftsCreate.as_view()),
        path("api/objects/drafts/modify/", ApiObjectsDraftsModify.as_view()),
        path("api/objects/drafts/permissions/", ApiObjectsDraftsPermissions.as_view()),
        path(
            "api/objects/drafts/permissions/set/",
            ApiObjectsDraftsPermissionsSet.as_view(),
        ),
        path("api/objects/drafts/publish/", ApiObjectsDraftsPublish.as_view()),
        path("api/objects/drafts/read/", ApiObjectsDraftsRead.as_view()),
        path("api/objects/drafts/token/", ApiObjectsDraftsToken.as_view()),
        path("api/objects/publish/", ApiObjectsPublish.as_view()),
        path("api/objects/search/", ApiObjectsSearch.as_view()),
        path("api/objects/validate/", ValidateBCO.as_view()),
        path("api/objects/token/", ApiObjectsToken.as_view()),
        path("api/objects/published/", ApiObjectsPublished.as_view()),
        path("api/prefixes/create/", ApiPrefixesCreate.as_view()),
        path("api/prefixes/delete/", ApiPrefixesDelete.as_view()),
        path("api/prefixes/permissions/set/", ApiPrefixesPermissionsSet.as_view()),
        path("api/prefixes/token/", ApiPrefixesToken.as_view()),
        path("api/prefixes/token/flat/", ApiPrefixesTokenFlat.as_view()),
        path("api/prefixes/modify/", ApiPrefixesModify.as_view()),
        path("api/public/describe/", ApiPublicDescribe.as_view()),
    ]
