...
def post_api_objects_drafts_publish(request):
    ...
    for publish_object in bulk_request:
        ...
        if draft_exists is False:
            returning.append(
                db_utils.messages(parameters={"object_id": publish_object["draft_id"]})[
                    "404_object_id"
                ]
            )
            any_failed = True
        ...
        if object_exists is True:
            ...
            returning.append(db_utils.messages(parameters)["409_object_conflict"])
            any_failed = True
            continue
        ...
        if draft_exists is True:
            ...
            if prefix_auth is True:
                ...
                if delete_draft is True:
                    ...
                    returning.append(
                        db_utils.messages(parameters=versioned)[
